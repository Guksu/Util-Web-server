...
let CreateUserInput = class CreateUserInput extends (0, graphql_1.PickType)(user_entity_1.User, [
    'id',
    'name',
    'password',
]) {
...
let CreateUserOutput = class CreateUserOutput extends output_dto_1.CommonOutput {
};
